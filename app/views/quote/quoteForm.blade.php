...
<div class="page-header"><h1>{{ trans('title.AlıntıPaylaş') }}<small>{{ trans('title.AlıntıPaylasSmall') }}</small></h1></div>
<div class="well">
...
<div class="input-prepend">
    ...
    <label class="control-label" for="inputEmail">{{ trans('title.AlıntıYapılan') }}</label>
    <div class="controls">
	...
	<div class="control-group">
    <label class="control-label" for="inputEmail">{{ trans('title.Alıntı') }}</label>
    <div class="controls">
	{{ Form::textarea('quote','',array('class'=>'form-control','rows'=>'3')) }}
	</div></div>
	
	<div class="control-group">
    <label class="control-label" for="inputEmail">{{ trans('title.AlıntıYapılanEser') }}</label>
    <div class="controls">
	
	{{ Form::text('product_name','',array('class'=>'form-control')) }}
	<br/><br/>
	{{ Form::submit(trans('title.AlıntıGonder'),array('class'=>'btn btn-large btn-success')) }}
	{{ Form::close() }}
